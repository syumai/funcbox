...
const links = [
  ...
  {
    href: "https://github.com/syumai/funcbox",
    label: "funcbox",
  },
];
      ...
      <section className="mx-auto flex max-w-4xl flex-col gap-8">
        <div className="flex flex-col gap-4">
          ...
          <h1 className="max-w-2xl text-4xl font-semibold leading-tight sm:text-5xl">
            Build Next.js-style apps with Vite and deploy them to your own funcbox.
          </h1>
          <p className="max-w-2xl text-lg leading-8 text-slate-700">
            This App Router project is wired for vinext, Tailwind CSS, and funcbox.
          </p>
        </div>
        ...
        <div className="grid gap-4 sm:grid-cols-3">
          ...
          <div className="rounded-lg border border-slate-200 bg-white p-5">
            ...
            <p className="mt-2 text-sm leading-6 text-slate-600">Create the production bundle funcbox serves.</p>
            <code className="mt-4 block rounded bg-slate-100 px-3 py-2 text-sm">pnpm run build</code>
          </div>
          <div className="rounded-lg border border-slate-200 bg-white p-5">
            <h2 className="font-semibold">Deploy</h2>
            <p className="mt-2 text-sm leading-6 text-slate-600">Ship the built bundle to your funcbox server.</p>
            <code className="mt-4 block rounded bg-slate-100 px-3 py-2 text-sm">funcbox deploy</code>
          </div>
        </div>
